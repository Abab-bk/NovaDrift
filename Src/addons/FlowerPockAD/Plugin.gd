...
class AndroidExportPlugin extends EditorExportPlugin:
    ...
    func _get_android_libraries(platform, debug) -> PackedStringArray:
        return PackedStringArray([
                "FlowerPockAD/bin/libs/FlowerAD-release.aar", "FlowerPockAD/bin/libs/csj_ad_sdk_231212.aar", "FlowerPockAD/bin/libs/gdt_ad_sdk_231121.aar", "FlowerPockAD/bin/libs/pocket_ad_sdk_3.3.1.aar", ])